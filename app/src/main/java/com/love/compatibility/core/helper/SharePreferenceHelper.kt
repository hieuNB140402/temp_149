...
import com.love.compatibility.core.utils.key.PermissionKey.CAMERA_KEY
import com.love.compatibility.core.utils.key.PermissionKey.NOTIFICATION_KEY
import com.love.compatibility.core.utils.key.PermissionKey.QUANTITY_UNZIPPED
import com.love.compatibility.core.utils.key.PermissionKey.STORAGE_KEY
import com.love.compatibility.core.utils.key.SharePreferenceKey
import com.love.compatibility.core.utils.key.SharePreferenceKey.COUNT_BACK_KEY
import com.love.compatibility.core.utils.key.SharePreferenceKey.FIRST_LANG_KEY
import com.love.compatibility.core.utils.key.SharePreferenceKey.FIRST_PERMISSION_KEY
import com.love.compatibility.core.utils.key.SharePreferenceKey.KEY_LANGUAGE
import com.love.compatibility.core.utils.key.SharePreferenceKey.RATE_KEY
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.love.compatibility.core.utils.key.SharePreferenceKey.EDIT_KEY
...
class SharePreferenceHelper(val context: Context) {
    ...
    // Edit
    fun getIsFirstEdit(): Boolean {
        return preferences.getBoolean(EDIT_KEY, true)
    }

    fun setIsFirstEdit(isFirstAccess: Boolean) {
        val editor = preferences.edit()
        editor.putBoolean(EDIT_KEY, isFirstAccess)
        editor.apply()
    }
}